...
import { Copy, Download, ThumbsUp, ThumbsDown, Loader2, Info, Code as CodeIcon, Send, Trash2 } from 'lucide-react'
              ...
              >
                <CardContent className="p-3 md:p-4">
                  <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                    {msg.role === "agent" ? (
                      <div className="h-7 w-7 md:h-8 md:w-8 rounded-full bg-gradient-to-br from-primary to-indigo-600 flex items-center justify-center text-white text-xs font-bold flex-shrink-0">AI</div>
                    ) : (
                  ...
                  {msg.role === "agent" && (
                    <div className="flex items-center gap-1 mt-2 md:mt-3 pt-2 border-t">
                      <Button 
                        variant="ghost" 
                        size="sm" 
